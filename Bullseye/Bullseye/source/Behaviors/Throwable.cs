...
internal class ThrowableBehavior : RangedWeaponBehavior
{
    public ThrowableBehavior(CollectibleObject collObj) : base(collObj) { }

    public override void OnLoaded(ICoreAPI api)
    {
        base.OnLoaded(api);

        Stats.WeaponType = WeaponsType.Throwable;
    }
    ...
    public override void OnShot(ItemSlot slot, Entity projectileEntity, EntityAgent byEntity)
    {
        ...
        if (byEntity is EntityPlayer)
        {
            ...
            collObj.RefillSlotIfEmpty(slot, byEntity, (stack) =>
            {
